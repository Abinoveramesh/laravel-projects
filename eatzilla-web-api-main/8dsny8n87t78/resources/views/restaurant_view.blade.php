      ...
      <div class="content-body">
       <div class="card">
        ...
        <div class="row">
            ...
            <div class="row m-1">
                <dt class="col-sm-3 order-txt p-0">Suburb </dt>
                <dd class="col-sm-9 order-txt "><span>: @isset($restaurant->city_list) @foreach($restaurant->city_list as $city_name) {{$city_name->city}} @endforeach @endisset</span> </dd>
            </div>
            @if(isset($restaurant->Area->area))
             <div class="row m-1">
                <dt class="col-sm-3 order-txt p-0">Apt/ Suite </dt>
        ...
        <div class="card-header">
         ...
         <br>
            ...
            <div class="row m-1">
             ...
             <div class="row m-1">
                <dt class="col-sm-3 order-txt p-0">Restaurant Address </dt>
