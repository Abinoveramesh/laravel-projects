                        ...
                        <div class="row">
                          <div class="col-md-6">
                            ...
                            <label class="radio-inline">
                                <input type="radio" value="0" name="food_type">No
                            </label>
                            <label class="radio-inline">
                                <input type="radio" value="1" name="food_type" checked="">Yes
                            </label>
                          ...
                          <div class="col-md-6">
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" name="packaging_charge" required class="form-control" id="price">
                            </div> 
