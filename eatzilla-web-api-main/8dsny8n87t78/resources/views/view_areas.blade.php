                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              ...
                              <!-- <button type="button" class="btn btn-success btn-sm link_clr" data-id="1" data-toggle="modal"  data-target="#delete{{$area->id}}"><i class="ft-delete"></i></button></li> -->
                            </td>
                          ...
                          <div class="modal animated slideInRight text-left" id="delete{{$area->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel76" aria-hidden="true">
                                       <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                         <div class="modal-header">
