                        ...
                        <div class="row">
                          <div class="col-md-12">
                            ...
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                <div class="d-inline-block custom-control custom-radio mr-1">
                                  <input type="radio" name="coupon_type" class="custom-control-input" value="1" id="all_user" @if(isset($data->coupon_type)) @if($data->coupon_type==1) checked @endif @else checked @endif>
