        ...
        <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
          ...
          <div class="row breadcrumbs-top d-inline-block">
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{url('/')}}/admin/dashboard" class="colorname">{{strtoUpper(trans('constants.dashboard'))}}</a></li>
                <li class="breadcrumb-item"><a href="#" class="colorname">{{ strtoUpper(trans('constants.email_setting')) }}</a>
                </li>
              </ol>
            </div>
          </div>
                      ...
                      <div class="row">
                       ...
                       <div class="form-group row">
                        <label class="col-md-2"></label>
                          <div class="col-md-10">
                            <button type="submit" class="btn btncolorname mr-1" style="padding: 10px 15px;">Update Settings</button> &nbsp;
