          ...
          <div class="row breadcrumbs-top d-inline-block">
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="#" class="brand-font-link-color">{{ strtoUpper(trans('constants.add')) }} {{ strtoUpper(trans('constants.city')) }}</a>
                </li>
              </ol>
            </div>
          </div>
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                             ...
                             <input type="number" class="form-control" name="delivery_charge_first_2_km" placeholder="Enter First 3 KM Charge In (Rupees ₹)" required value="{{ old('delivery_charge_first_2_km') }}">
                            </div> 
                          </div>
                          <div class="col-md-6">
                            <div class="form-group">
                              <label  for="min_dist_delivery_price">Remaining Each KM Charge (Rupees ₹) <span style="color: red;">*</span></label>
                              <input type="number" class="form-control" name="delivery_charge_remaining_each_km" placeholder="Enter Remaining Each KM Charge In (Rupees ₹)" required value="{{ old('delivery_charge_remaining_each_km') }}" >
                            </div>
                          </div>
                        </div>
