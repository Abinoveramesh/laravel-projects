          ...
          <div class="row">
            ...
            <div class="col-xl-3 col-md-6 col-12 mb-2">
                    <div class="information">
                        ...
                        <div class="py-1 px-2">
                            <h5 class="success">Today's Orders</h5>
            ...
            <div class="col-xl-3 col-md-6 col-12 mb-2">
                    <div class="information">
                        ...
                        <div class="py-1 px-2">
                            <h5 class="warning">Total Sale</h5>
          ...
          <div class="row">
            <div class="col-md-8">
              <div class="card">
                ...
                <div class="card-content collapse show">
                  <div class="card-body">
                    <div id="pie-chart" style="margin-bottom:128px;" class="height-400 "></div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-15">
              <div class="card">
                ...
                <div class="card-content collapse show">
                  <div class="card-body">
                    <div id="basic-area" class="height-400"></div>
                  </div>
                </div>
              </div>
            </div>
...
@endif
 ...
 <script src="{{URL::asset('public/app-assets/vendors/js/charts/echarts/echarts.js')}}" type="text/javascript"></script>
  ...
  {
    window.location = 'http://161.35.142.163/food-web/truely-food-restaurant/';
  }
</script>
...
<script type="text/javascript">
  ...
  function update_availability(obj)
{
