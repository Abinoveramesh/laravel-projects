          ...
          <div class="row breadcrumbs-top d-inline-block">
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="#" class="brand-font-link-color">@if(session()->get('role')==1) {{strtoUpper(trans('constants.order'))}} @else {{strtoUpper(trans('constants.restaurant'))}} @endif {{strtoUpper(trans('constants.report'))}}</a>
                </li>
