        ...
        <div class="breadcrumb-wrapper col-12">
          <ol class="breadcrumb">
            <li class="breadcrumb-item">
              <a href="{{url('/')}}/admin" class="brand-font-link-color">{{strtoUpper(trans('constants.dashboard'))}}</a>
            </li>
            <li class="breadcrumb-item">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-12">
                             ...
                             <div class="col-md-4 col-md-offset-4">
                              <button type="submit" class="btn success-button-style mr-1" style="padding: 10px 15px;"> Pay now
                              </button>
                            </div>
