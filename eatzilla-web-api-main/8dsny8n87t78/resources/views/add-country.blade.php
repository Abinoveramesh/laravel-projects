    ...
    <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
      ...
      <div class="row breadcrumbs-top d-inline-block">
        <div class="breadcrumb-wrapper col-12">
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#" class="colorname">{{trans('constants.add')}} {{trans('constants.country')}}</a>
            </li>
          </ol>
        </div>
      </div>
              ...
              <div class="card-body">
                <form action="{{url('/')}}/admin/save_country" class="icons-tab-steps wizard-notification" method="post">
                  ...
                  <div class="form-actions center">
                    <a href="{{url('/')}}/admin/country_list" class="btn btn-warning mr-1" style="padding: 10px 15px;">
                      <i class="ft-x"></i> Cancel
                    </a>
                   <button type="submit" class="btn mr-1 btncolorname" style="padding: 10px 15px;">
