        ...
        <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
          ...
          <div class="row breadcrumbs-top d-inline-block">
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb">
                 <li class="breadcrumb-item"><a href="{{url('/')}}/admin/order_dashboard" class="colorname">{{strtoUpper(trans('constants.order'))}} {{strtoUpper(trans('constants.dashboard'))}}</a>
                </li> 
                <li class="breadcrumb-item"><a href="#" class="colorname">{{strtoUpper(trans('constants.order_det'))}}</a>
                </li>
              </ol>
            </div>
          </div>
              ...
              <div class="card">
                <div class="card-head">
                  <div class="card-header">
                    ...
                    <a href="{{url('/')}}/admin/generate_pdf/{{$data->id}}" style="float:right" target="_blank" class="btn btncolorname btn-sm"><b style="font-size: 16px;">Invoice</b></a>
                    </h4>
                    <hr><br>
                  </div>
                </div>
                  ...
                  <div class="col-xl-6 col-lg-6 col-md-6 pt-3 px-2">
                    <div class="border">
                      ...
                      <div class="my-card">
                        ...
                        @if($address_count == 1)
                         <div class="row m-1">
                          <dt class="col-sm-4 order-txt p-0"> {{trans('constants.delivery_address')}}  </dt>
                        </div>
                         <div class="row m-1">
                          <dt class="col-sm-4 order-txt p-0"> {{trans('constants.address')}}  </dt>
                          <dd class="col-sm-8 order-txt "><span>:  @isset($delivery_address_detail->address) {{$delivery_address_detail->address}} @endisset </span> </dd>
                        </div>  
                        <div class="row m-1">
                          <dt class="col-sm-4 order-txt p-0"> {{trans('constants.building')}}  </dt>
                          <dd class="col-sm-8 order-txt "><span>:  @isset($delivery_address_detail->building) {{$delivery_address_detail->building}} @endisset </span> </dd>
                        </div>  
                        <div class="row m-1">
                          <dt class="col-sm-4 order-txt p-0"> {{trans('constants.block_number')}}  </dt>
                          <dd class="col-sm-8 order-txt "><span>:  @isset($delivery_address_detail->block_number) {{$delivery_address_detail->block_number}} @endisset </span> </dd>
                        </div> 
                        <div class="row m-1">
                          <dt class="col-sm-4 order-txt p-0"> {{trans('constants.flat_number')}}  </dt>
                          <dd class="col-sm-8 order-txt "><span>:  @isset($delivery_address_detail->flat_no) {{$delivery_address_detail->flat_no}} @endisset </span> </dd>
                        </div> 
                         <div class="row m-1">
                          <dt class="col-sm-4 order-txt p-0"> {{trans('constants.landmark')}}  </dt>
                          <dd class="col-sm-8 order-txt "><span>:  @isset($delivery_address_detail->landmark) {{$delivery_address_detail->landmark}} @endisset </span> </dd>
                        </div> 
                         <div class="row m-1">
                          <dt class="col-sm-4 order-txt p-0"> {{trans('constants.address_direction')}}  </dt>
                          <dd class="col-sm-8 order-txt "><span>:  @isset($delivery_address_detail->address_direction) {{$delivery_address_detail->address_direction}} @endisset </span> </dd>
                        </div> 
                        @endif                    
                      </div>
                    </div>
                    ...
                    <div class="border">
                      ...
                      <div class="my-card">
                        ...
                        <div class="row m-1">
                         ...
                         <div class="row m-1">
                          <dt class="col-sm-5 order-txt p-0"> Secondary Phone Number </dt>
                          <dd class="col-sm-7 order-txt "><span>: {{$data->Restaurants->phone2}}</span> </dd>
                        </div> 
                        <div class="row m-1">
                        ...
                        <div class="row m-1">
                          ...
                          <dd class="col-sm-7 order-txt "><span>: @if(!empty($data->Restaurants->city_list)) @foreach($data->Restaurants->city_list as $city) {{$city->city}}  @endforeach  @endif</span> </dd>
                        </div> 
                        <div class="row m-1">
                    ...
                    <div class="border">
                      ...
                      <div class="my-card">
                        ...
                        <div class="row m-1">
                          ...
                          @php
                            $addon_price = 0;
                            if(isset($detail->RequestdetailAddons)){
                            $addons = $detail->RequestdetailAddons->toArray();
                              if(!empty($addons)){
                                $addon_price = array_reduce($addons, "sum");
                              }
                            }
                            $food_price = ($detail->food_quantity_price=='0.000')?$detail->Foodlist->price:$detail->food_quantity_price;
                            $price = ( $detail->quantity * ($food_price + $addon_price));
                          
                          @endphp
                          <dd class="col-sm-7 order-txt "><span>: {{DEFAULT_CURRENCY_SYMBOL}} {{$price}} </span> </dd>
                        ...
                        <div class="row m-1">
                          <dt class="col-sm-5 order-txt p-0"> {{trans('constants.restaurant_discount')}} </dt>
                          <dd class="col-sm-7 order-txt "><span>:  {{DEFAULT_CURRENCY_SYMBOL}} {{ $data->restaurant_discount }}</span> </dd>
                        </div> 
                        <div class="row m-1">
                          <dt class="col-sm-5 order-txt p-0"> {{trans('constants.coupon_discount')}} </dt>
                          <dd class="col-sm-7 order-txt "><span>:  {{DEFAULT_CURRENCY_SYMBOL}} {{ $data->offer_discount }}</span> </dd>
                        </div> 
                        <div class="row m-1">
                        ...
                        <div class="row m-1">
                          <dt class="col-sm-5 order-txt p-0"> Special instruction</dt>
                          <dd class="col-sm-7 order-txt "><span>: {{$data->comments}}</span> </dd>
                        </div>  
                        @endif 
                      </div>
                    </div>
