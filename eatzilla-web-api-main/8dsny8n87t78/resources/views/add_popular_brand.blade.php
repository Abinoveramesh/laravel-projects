                    ...
                    <fieldset>
                        <div class="row">
                          <div class="col-md-12">
                            ...
                            <div class="col-md-9">
                              @if(isset($data->image) && file_exists(DOCROOT.UPLOADS_PATH.$data->image))
                              ...
                              @endif
                              <input type='file' accept=".png, .jpg, .jpeg" name="image" onchange="readURL(this);" / style="padding:10px;background:000;">
                          </div>
                         </div>
