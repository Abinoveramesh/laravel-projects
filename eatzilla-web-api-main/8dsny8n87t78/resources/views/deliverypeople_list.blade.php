        ...
        <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
          ...
          <div class="row breadcrumbs-top d-inline-block">
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{url('/')}}/admin/driver_list">DRIVER LIST</a>
                </li>
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <!-- <button class="table-btn btn btn-icon btn-danger" form="resource-settle-55">Unsettle</button> -->
                             <li><a href="{{url('/')}}/admin/edit_delivery_boy_details/{{$d->driver_id}}" class="button btn btn-icon btn-success mr-1 link_clr"><i class="ft-edit"></i></a>
