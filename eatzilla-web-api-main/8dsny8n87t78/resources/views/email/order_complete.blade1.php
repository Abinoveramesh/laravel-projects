...
<body style="/* padding-left: 30%;padding-right: 10%; */     width: 60%;margin: 0px;">
	<section style="background-image: url('{{URL::asset(UPLOADS_EMAIL_PATH)}}/header_bg.png');padding: 20px 0px 100px 30px;background-repeat: no-repeat;background-position: right;background-size: cover;">
		<div style="width: 50%;max-width: 50%;display: inline-block;">
			<img src="{{URL::asset(RESTAURANT_UPLOADS_PATH.SITE_LOGO)}}" alt="{{APP_NAME}}" style="width: 170px;">
		</div>
	...
	<table style="width: 100%;padding-top: 30px;padding-left: 30px;">
		<tr style="font-family: 'Source Sans Pro', sans-serif;font-size: 20px;font-weight: normal;font-style: normal;font-stretch: normal;line-height: 1.7;letter-spacing: 0.8px;text-align: left;color: #686868;">
			...
			<td style="float: right;padding-right: 100px;">{{DEFAULT_CURRENCY_SYMBOL}} {{$data->item_total}}</td>
		</tr>
		<tr style="font-family: 'Source Sans Pro', sans-serif;font-size: 20px;font-weight: normal;font-style: normal;font-stretch: normal;line-height: 1.7;letter-spacing: 0.8px;text-align: left;color: #686868;">
			<td style="padding-left: 15px;">Tax</td>
			<td style="float: right;padding-right: 100px;">{{DEFAULT_CURRENCY_SYMBOL}} {{$data->tax}}</td>
		</tr>
		<tr style="font-family: 'Source Sans Pro', sans-serif;font-size: 20px;font-weight: normal;font-style: normal;font-stretch: normal;line-height: 1.7;letter-spacing: 0.8px;text-align: left;color: #686868;">
			<td style="padding-left: 15px;">Delivery Fee</td>
			<td style="float: right;padding-right: 100px;">{{DEFAULT_CURRENCY_SYMBOL}} {{$data->delivery_charge}}</td>
		</tr>
		<tr style="font-family: 'Source Sans Pro', sans-serif;font-size: 20px;font-weight: normal;font-style: normal;font-stretch: normal;line-height: 1.7;letter-spacing: 0.8px;text-align: left;color: #686868;">
			<td style="padding-left: 15px;">Discount</td>
			<td style="float: right;padding-right: 100px;">{{DEFAULT_CURRENCY_SYMBOL}} {{$data->offer_discount}}</td>
		</tr>
	</table>
	<div style="border: 1px solid #79636370;width: 690px;margin-left: 35px;margin-top: 20px;"></div>
	<table style="width: 100%;padding-top: 30px;padding-left: 30px;">
		...
		<table style="width: 100%;padding-top: 30px;padding-left: 30px;">
			<tr>
				<td style="width: 80px;padding-left: 15px;">
					<img src="{{url('/')}}{{UPLOADS_PATH}}{{$data->Deliverypartners->profile_pic}}" alt="Customer" style="width: 55.1px;border-radius: 50%;">
				</td>
				<td>
					<p style=" font-family: 'Source Sans Pro', sans-serif;font-size: 17px;font-weight: 600;font-style: normal;font-stretch: normal;line-height: 1.2;letter-spacing: 0.7px;text-align: left;color: #686868;">Delivered by <span style="color: #2a8c37;">@if(!empty($data->Deliverypartners)) {{$data->Deliverypartners->name}} @else Guest Partner @endif</span></p>
				</td>
			</tr>
		</table>
	</section>
	...
	<section style="background-color: #000000;padding-bottom: 30px;">
		<table style="width: 100%;padding-top: 30px;padding-left: 30px;">
			<tr>
				<td>
					<img src="{{URL::asset(RESTAURANT_UPLOADS_PATH.SITE_LOGO)}}" alt="{{APP_NAME}}" style="width: 170px;filter: invert(100%);">
				</td>
				<td>
		...
		<table style="width: 100%;padding-top: 30px;padding-left: 30px;">
			...
			<tr>
				...
				<td style="font-family: 'Source Sans Pro', sans-serif;font-size: 14px;font-weight: normal;font-style: normal;font-stretch: normal;line-height: 1.2;letter-spacing: 0.6px;text-align: left;color: #b2b2b2;">P.O Box 9090</td>
			</tr>
			<tr>
