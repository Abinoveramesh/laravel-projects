          ...
          <div class="row breadcrumbs-top d-inline-block">
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href=" " class="brand-font-link-color">ADD SUB ADMIN</a>
                </li>
              </ol>
            </div>
          </div>
                        ...
                        <div class="row">
                          <div class="col-md-12">
                            <div class="form-group">
                              ...
                              <input type="text"  pattern="[a-zA-Z0-9 ]{1,100}" title="Special characters are not allowed" class="form-control" required id="name" name="name" placeholder="Name">
                            </div>
                           ...
                           <div class="form-group">
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="number" pattern="[0-9]+" title="Phone number does not accept alphabetic and special characters" name="phone" required placeholder="Phone Number" required="" >  
                            </div>
                              ...
                              <div class="col-md-6 main-menu-content">
                                <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                                  <li class="active nav-item">
                                      <a href="javascript:;" class="colorname"  onclick="ChangePrivilegeBox(1);" title="Super Admin Dashboard">Super Admin Dashboard</a>
                                  </li>
                                  <li class="active nav-item">
                                      <a href="javascript:;" class="colorname" onclick="ChangePrivilegeBox(21);" title="Availablity Map">Availablity Map</a>
                                  </li>
                                  <li class="nav-item">
                                    <a href="javascript:;" class="colorname" onclick="ChangePrivilegeBox(2);" title="Order Management">Order Management</a>
                                  </li> 
                                 <!--  <li class="nav-item">
                                    <a href="javascript:;" class="colorname" onclick="ChangePrivilegeBox(3);" title="Restaurant">Restaurant</a>
                                  </li> -->
                                  <li class="nav-item">
                                      <a href="javascript:;" class="colorname" onclick="ChangePrivilegeBox(4);" title="City Management">Suburb Management</a>
                                  </li>
                                  <li class="nav-item">
                                      <a href="javascript:;" class="colorname" onclick="ChangePrivilegeBox(5);" title="Food Management">Food Management</a>
                                  </li>
                                  <li class="nav-item">
                                      <a href="javascript:;" class="colorname" onclick="ChangePrivilegeBox(6);" title="Driver Management">Driver Management</a>
                                  </li>
                                  <!-- <li class="nav-item">
                                      <a href="javascript:;" class="colorname" onclick="ChangePrivilegeBox(7);" title="Document Management">Document Management</a>
                                  </li> -->
                                  <!-- <li class="nav-item">
                                      <a href="javascript:;" class="colorname" onclick="ChangePrivilegeBox(8);" title="Cancellation Reasons">Cancellation Reasons</a>
                                  </li> -->
                                  <li class="nav-item">
                                      <a href="javascript:;" class="colorname" onclick="ChangePrivilegeBox(9);" title="Promocodes">Promocodes</a>
                                  </li>
                                  <li class="nav-item">
                                      <a href="javascript:;" class="colorname" onclick="ChangePrivilegeBox(10);" title="Restaurant Banner">Restaurant Banner</a>
                                  </li>
                                  <li class="nav-item">
                                      <a href="javascript:;" class="colorname" onclick="ChangePrivilegeBox(11);" title="Popular Brand">Popular Brand</a>
                                  </li>
                                  <li class="nav-item">
                                      <a href="javascript:;" class="colorname" onclick="ChangePrivilegeBox(12);" title="User Management">User Management</a>
                                  </li>
                                  <li class="nav-item">
                                      <a href="javascript:;" class="colorname" onclick="ChangePrivilegeBox(13);" title="Cuisines List">Cuisines List</a>
                                  </li>
                                 <!--  <li class="nav-item">
                                      <a href="javascript:;" class="colorname" onclick="ChangePrivilegeBox(14);" title="Addons List">Addons List</a>
                                  </li> -->
                                  <li class="nav-item">
                                      <a href="javascript:;" class="colorname" onclick="ChangePrivilegeBox(15);" title="Payout">Payout</a>
                                  </li>
                                  <!-- <li class="nav-item">
                                      <a href="javascript:;" class="colorname" onclick="ChangePrivilegeBox(16);" title="Food Quantity">Food Quantity</a>
                                  </li> -->
                                  <!-- <li class="nav-item">
                                      <a href="javascript:;" class="colorname" onclick="ChangePrivilegeBox(17);" title="Category">Category</a>
                                  </li> -->
                                  <li class="nav-item">
                                      <a href="javascript:;" class="colorname" onclick="ChangePrivilegeBox(18);" title="CMS MAnagement">CMS Management</a>
                                  </li>
                                  <li class="nav-item">
                                      <a href="javascript:;" class="colorname" onclick="ChangePrivilegeBox(19);" title="Settings">Settings</a>
                                  </li>
                                  <li class="nav-item">
                                      <a href="javascript:;" class="colorname" onclick="ChangePrivilegeBox(20);" title="Reports">Reports</a>
                                  </li>
                                </ul>
                              ...
                              <div class="col-md-6">
                                ...
                                <div class="pm_menu" id="pm_2" style="display:none;">
                                  ...
                                  <div class="pm_menu" id="pm_14" style="display:none;">
                                    <h4>Addons</h4>
                                    <div class="check_role_div">All &nbsp;<label class="stylish_check_all"><input type="checkbox" id="addons" onchange="doAll('cuisines[]',this)"/><small class="checkmark"></small></label></div>
                                    <ul class="privilage_opt_bordered">
                                      <li>
                            ...
                            <div class="form-actions">
                              ...
                              <button type="submit" onclick="javascript:return form_validation();" class="btn success-button-style mr-1" style="padding: 10px 15px;">
