...
class Custom {
    ...
    public static function upload_image($request,$param)
    {
       ...
       $filePath = "uploads";
        $filetype = Storage::disk('spaces')->putFile($filePath,$request->$param,'public');
        return $filetype;
    }
    ...
    public static function common_upload_images($request,$param,$path)
    {
        ...
        $filetype = Storage::disk('spaces')->putFile($path,$imageName,'public');
        return $filetype;
    }
