...
class Restaurants extends Authenticatable
{
    ...
    */
    ...
    {
        return $this->belongsToMany('App\Model\Addcity','restaurant_city','restaurant_id','city_id');
    }
    ...
    */
    ...
    {
        return $this->hasMany('App\Model\Category','restaurant_id','id');
    }

    /**
     * set relationship to banner.
     *
     */
    public function Banner()
    {
        return $this->hasMany('App\Model\Banner','restaurant_id','id');
    }
